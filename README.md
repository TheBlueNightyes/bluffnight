...
- **/aipac.** check yo donos
- **/ask.** MY TIME. MINE
- **/balance.** balance for now
- **/banish.** It's ggs
- **/betting.** the dumbest thing alive
- **/biologylist.** ...
- **/blackjack.** gamblers luck, right?
...
- **/curse.** nuke the whole generation
...
- **/funds.** we're still alive and kicking!
...
- **/ideology.** THE controversial command?
...
- [x] not interaction user checks
- [x] light economy system
- [x] channel affecting commands
